...
- Çalışma/Ödev 4: Klavyeden girilen iki sayının toplam, fark, çarpım, tam sayı bölümü bölümünden kalan ve ondalıklı sayı bölüm değerlerini ekrana yazdıran C programını yazınız.
