...
[Sınıflandırma slaytı için tıklayınız.](./slides/ders04.pdf)   
...
Veri dosyasını indirmek için [tıklayınız](./images/04_insurance_data.csv).


```python
df = pd.read_csv("04_insurance_data.csv")
df.head()
```
