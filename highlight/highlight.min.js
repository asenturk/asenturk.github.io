...
;hljs.registerLanguage("javascript",e)})();/*! `cpp` grammar compiled for Highlight.js 11.4.0 */
...
;hljs.registerLanguage("python-repl",a)})();/*! `java` grammar compiled for Highlight.js 11.4.0 */
(()=>{var e=(()=>{"use strict"
